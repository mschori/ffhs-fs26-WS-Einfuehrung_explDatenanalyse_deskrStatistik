...
Kann nur abzählbare, voneinander getrennte Werte annehmen.

**Stetiges Merkmal**<br>
Kann innerhalb eines Intervalls beliebig viele Zwischenwerte annehmen.

**Empirische Verteilungsfunktion**<br>
Das ist die Verteilungsfunktion der konkrekten Stichprobe.Das bedeutet: Für einen Wert x zählt man, wie viele Beobachtungen <= x sind, und teilt durch die Gesamtanzahl n.
...
- Reliablität: Wie genau misst ein Messinstrument?
  - Reliabilität beschreibt, wie stark ein gemessener Wert durch den "wahren Wert" bestimmt ist - und nicht durch Zufall oder Messfehler => Je kleiner der Fehleranteil, desto höher die Reliabilität!
  - Geringe Realibilität verhindert in der Regel Validität
  - Realibilität bedeutet, dass das Verfahren exakt misst
  - Ein Verfahren kann sehr zuverlässig falsche Dinge messen, z.B. wenn ein Sensor einen Offsetfehler hat => daher bedeutet ein hoch reliables Verfahren nicht automatisch hoch valide
- Validität: bedeutet, dass wirklich das gemessen wird, was gemessen werden soll
- Operationalisierung: legt fest, wie ein Merkmal messbar gemacht wird
